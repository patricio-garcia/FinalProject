...
class SettingsFragment : Fragment(R.layout.fragment_settings) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        btnApplyChanges.setOnClickListener {
            ...
            if(success) {
                Snackbar.make(requireView(), "Cambios guardados", Snackbar.LENGTH_SHORT).show()
            } else {
                Snackbar.make(requireView(), "Por favor, complete todos los datos", Snackbar.LENGTH_SHORT).show()
            }
        }
    }
    ...
    private fun applyChangesToSharedPref(): Boolean {
        ...
        sharedPref.edit()
            ...
            .apply()
        val toolbarText = "Sigamos, $nameText!"
