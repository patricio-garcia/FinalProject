...
import com.serlitoral.running.adapters.RunAdapter
import com.serlitoral.running.other.Constants.Companion.REQUEST_CODE_LOCATION_PERMISSION
import com.serlitoral.running.other.SortType
...
class RunFragment : Fragment(R.layout.fragment_run), EasyPermissions.PermissionCallbacks {
    ...
    private val itemTouchHelperCallback = object : ItemTouchHelper.SimpleCallback(
        ...
        override fun onSwiped(viewHolder: RecyclerView.ViewHolder, direction: Int) {
            ...
            Snackbar.make(requireView(), "Corrida eliminada correctamente", Snackbar.LENGTH_LONG).apply {
                setAction("Deshacer") {
    ...
    private fun requestPermissions() {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.Q) {
            EasyPermissions.requestPermissions(
                this,
                "Debe aceptar el permiso de ubicación para usar esta aplicación",
